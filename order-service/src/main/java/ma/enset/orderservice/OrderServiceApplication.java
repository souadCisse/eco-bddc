...
import ma.enset.orderservice.restclients.CustomerRestClient;
...
public class OrderServiceApplication {
	...
	@Bean
	CommandLineRunner commandLineRunner(OrderRepository orderRepository, ProductItemRepository productItemRepository, InventoryRestClient inventoryRestClient, CustomerRestClient customerRestClient){
		return args -> {
